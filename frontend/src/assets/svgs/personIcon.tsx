...
export default function PersonIcon({ color, width, height }: IconProps) {
  return (
    <svg
      width={width || "30"}
      height={height || "30"}
    ...
    >
      <g>
        <path
          className="st0"
          d="M256,0C114.613,0,0,114.616,0,255.996C0,397.382,114.613,512,256,512c141.386,0,256-114.617,256-256.004
